...
function unitPlacement(unit: AcceptedPlateUnitInput): "auto" | "manual" | "unplaced" {
  return unit.placement === "manual" || unit.placement === "unplaced" ? unit.placement : "auto";
}

function unitPinned(unit: AcceptedPlateUnitInput): boolean {
...
function unitDimensionsFitPrintableArea(plate: AcceptedPlateInput, unit: AcceptedPlateUnitInput): boolean {
  return (
